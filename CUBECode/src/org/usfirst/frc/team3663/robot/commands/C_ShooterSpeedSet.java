...
public class C_ShooterSpeedSet extends Command {
    ...
    protected void execute() {
    	if (Robot.oi.OPJoystick.getPOV()==0 && Robot.ss_ShooterMainWheel.SHOOTER_EST_MAX_SPEED > Robot.ss_ShooterMainWheel.targetvalue && press==false){
    		Robot.ss_ShooterMainWheel.targetvalue += 50;
    		press=true;
    	}
    	if (Robot.oi.OPJoystick.getPOV()==180 && Robot.ss_ShooterMainWheel.targetvalue >0 && press==false){
    		Robot.ss_ShooterMainWheel.targetvalue -= 50;
    		press=true;
    	}
